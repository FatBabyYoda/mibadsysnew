...
public class LaggTillAgent extends javax.swing.JFrame {
    ...
    private void regBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_regBtnActionPerformed
        try {
            ...
            if (losenord.equals(uprord) && Validring.finnsText(namnField) && Validring.finnsText(teleField) && !Validring.finnsEpostenRedan(epost) && Validring.rattLangd(losenField, 6)) {
